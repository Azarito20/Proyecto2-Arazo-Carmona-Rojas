...
public class Documents extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        GoprintButton = new javax.swing.JButton();
        document = new javax.swing.JButton();
        EliminateUsersButton1 = new javax.swing.JButton();
        ...
        Fondo2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 90, -1, 40));
        ...
        Fondo2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 60, 220, 40));
        ...
        GoprintButton.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        GoprintButton.setText("Enviar a imprimir documentos");
        GoprintButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                GoprintButtonActionPerformed(evt);
            }
        });
        Fondo2.add(GoprintButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 210, 240, 40));

        document.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        document.setText("Agregar documento");
        document.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                documentActionPerformed(evt);
            }
        });
        Fondo2.add(document, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 150, 240, 40));

        EliminateUsersButton1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        EliminateUsersButton1.setText("Eliminar documentos");
        EliminateUsersButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EliminateUsersButton1ActionPerformed(evt);
            }
        });
        Fondo2.add(EliminateUsersButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 270, 240, 40));
    ...
    private void GoprintButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GoprintButtonActionPerformed
    ...
    private void EliminateUsersButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminateUsersButton1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_EliminateUsersButton1ActionPerformed
    ...
    private javax.swing.JButton EliminateUsersButton1;
    private javax.swing.JButton Exit;
    private javax.swing.JPanel Fondo1;
    private javax.swing.JPanel Fondo2;
    private javax.swing.JButton GoprintButton;
